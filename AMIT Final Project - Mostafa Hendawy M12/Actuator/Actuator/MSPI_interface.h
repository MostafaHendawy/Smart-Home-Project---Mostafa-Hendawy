...
/*This function is responsible for receiving a character from SPI bus*/
u8_t mspi_recieve();

/*This function is responsible for initializing Slave*/
void mspi_initSlave(u8_t data_mode, u8_t clk_prescaler);
